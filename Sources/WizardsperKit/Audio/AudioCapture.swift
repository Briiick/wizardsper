...
public final class AudioCapture: @unchecked Sendable {
    ...
    /// calls it.
    @MainActor public var onFailure: (@Sendable (WizardsperError) -> Void)?
    ...
    public static func ensureMicrophoneAccess() async throws {
        ...
        case .notDetermined:
            ...
            guard granted else {
                ...
                throw WizardsperError.microphoneDenied
            }
    ...
    public func start() throws {
        ...
        // to get wrong. Wizardsper creates exactly one engine, so there is nothing
    ...
    private func buildEngine() throws {
        ...
        guard inputFormat.sampleRate > 0, inputFormat.channelCount > 0 else {
            throw WizardsperError.audioEngineFailed(
        ...
        guard
            ...
            throw WizardsperError.audioEngineFailed("could not describe 16 kHz mono Float32")
        }
        ...
        guard
            ...
            throw WizardsperError.audioEngineFailed("could not allocate the 16 kHz output buffer")
        }
        ...
        do {
            ...
            throw WizardsperError.audioEngineFailed(error.localizedDescription)
        }
    ...
    private func handleConfigurationChange() {
        ...
        do {
            ...
            let failure =
                (error as? WizardsperError)
                ?? WizardsperError.audioEngineFailed(error.localizedDescription)
            Log.audio.error(
