...
public actor StreamingASR {
    ...
    public func warmUp() throws {
        try autoreleasepool {
            ...
            if try MLArrayReader.isAllZero(encoded, named: "encoded") {
                throw WizardsperError.encoderProducedSilence
            }
        }
        try reset()
        ...
        for frame in 0..<frames {
            ...
            while symbols < maxSymbolsPerFrame {
                guard let prediction = decoderOut else {
                    throw WizardsperError.modelOutputMissing("decoder_out")
                }
    ...
    private func predict(
        ...
        do {
            ...
            throw WizardsperError.modelLoadFailed(name, underlying: error.localizedDescription)
        }
    }
}
