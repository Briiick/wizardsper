...
/// Wizardsper's only scene is the menu bar: there is no `App` body to hang a
...
final class DashboardWindowController: NSWindowController {
    ...
    private static let autosaveName = "WizardsperDashboardWindow"
    ...
    init(settings: WizardsperKit.Settings, model: DashboardModel) {
