...
/// window ever took focus, the frontmost app would become Wizard and the
...
final class FlowBarPanel: NSPanel {
    ...
    init(model: FlowBarModel) {
        ...
        // Panels hide themselves when their application deactivates. Wizard is a
    ...
    func show() {
        ...
        // display can be unplugged while Wizard sits idle in the menu bar.
        position(on: screen)
