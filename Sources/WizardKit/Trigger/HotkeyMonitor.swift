...
/// function-key row in every app on the machine for as long as Wizard runs.
///
/// ## Callback contract
...
public final class HotkeyMonitor {
    ...
    ///
    /// - Throws: `WizardError.inputMonitoringDenied` when the tap cannot be
    ...
    public func start() throws {
        ...
        guard
            ...
            throw WizardError.inputMonitoringDenied
        }
